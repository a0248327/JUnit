...
/**
 * A SampleServlet to demonstrate the differences of unit-testing J2EE
 * components.
 * 
 * @version $Id$
 */
public class SampleServlet extends HttpServlet {
	...
	/**
	 * This method checks to see if the authenticated property has been
	 * setup and returns its boolean value.
	 * 
	 * @param request
	 * @return
	 */
