...
/**
 * A service that has different methods that we can use. Currently it holds only
 * the transfer method, which transfers money from one account to the other.
 * 
...
public class AccountService {
	...
	/**
	 * A transfer method which transfers the amount of money from the
	 * account with the senderId to the account of beneficiaryId.
	 * 
	 * @param senderId
	 * @param beneficiaryId
	 * @param amount
