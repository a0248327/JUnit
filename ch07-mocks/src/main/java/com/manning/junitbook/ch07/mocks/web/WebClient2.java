...
/**
 * A sample WebClient that opens a connection to a web-server and reads the data
 * from it.
 * 
...
public class WebClient2 {
	/**
	 * Open a connection to the given URL and read the content out of it. In
	 * case of an exception we return null.
	 * 
