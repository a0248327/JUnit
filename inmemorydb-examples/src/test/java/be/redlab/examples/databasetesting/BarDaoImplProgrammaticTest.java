 ...
 * This test extends from {@link AbstractDaoTest} where the Spring and Unitils
 * configuration setup is defined. In this test we create an entity in
 * {@link #setup()} and in {@link #getByName()} we try to fetch the stored
 * entity. To be sure that we don't get that same entity for another name
 * {@link #getUnknownByName()} tries to retrieve an unknown {@link Bar}.
 */
